...
url: internal://regnology/skill-issue/skills/captain-hindsight
authors: [Regnology / skill-issue contributors]
captured: 2026-05-28
source_type: repo
...
*Source: shared via captainhindsight.zip. Internal Regnology Bitbucket. Companion to the wider [`skill-issue`](https://bitbucket.regnology.net/projects/ORANGE/repos/skill-issue) catalog.*
...
The Regnology `skill-issue` repo contains 15 skills and 1 rule beyond captain-hindsight. Two are potentially relevant to this KB and flagged for follow-up:
...
- `sources/2026-05-28-regnology-teams-snippet.md` — the Teams conversation where captain-hindsight was described
