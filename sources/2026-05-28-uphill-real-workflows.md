...
- "Automate what you repeat" → skills. But how do you know a pattern is ready to be encoded as a skill vs still evolving? The Regnology captain-hindsight pattern (post-session retrospective) is a mechanism for answering this, but it's not in this talk.
...
- `sources/2026-05-28-regnology-teams-snippet.md` — similar model-routing-by-task-type practice, from Regnology team
