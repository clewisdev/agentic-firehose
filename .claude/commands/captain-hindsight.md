...
2. For each friction point, classify the proposed action as exactly one of:
   - **Rule**: edit/create a rule file (`.claude/rules/*.md` or AGENTS.md section).
   - **Skill**: edit/create a skill under `skills/*/SKILL.md` and `.claude/commands/*.md`.
   - **Script**: edit/create a project script.
   - **Doc**: edit a project guidance file or AGENTS.md.
...
- For **Rule/Skill/Script/Doc/Test** entries: edit in place, then commit if the user wants the follow-up implemented.
