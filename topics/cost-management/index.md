...
- [Internal Teams snippet](../../sources/2026-05-28-internal-teams-snippet.md) — captain-hindsight: post-session retrospective that improves future sessions by making interactions more deterministic. Complement to runtime compression. Also: multi-model routing by task type.
