...
- [Emerging Patterns in Building GenAI Products](../../sources/2025-02-25-emerging-patterns-genai-products.md) — Fowler/Subramaniam: RAG as the production pattern for extending LLM knowledge; nine patterns across knowledge enhancement (RAG, fine-tuning) and safety/reliability (evals, guardrails, reranker, query rewriting)
- [Open Knowledge Format (OKF): vendor-neutral standard for LLM context](../../sources/2025-06-13-open-knowledge-format-okf.md) — Google OKF: vendor-neutral standard for LLM-maintained knowledge bases — version-control-native, human-readable, no graph DB; key objection: agents propagate errors consistently at scale when updating from incorrect beliefs
- [Understand Anything: Interactive Knowledge Graph for Large Codebases](../../sources/2025-06-14-understand-anything-codebase.md) — knowledge-graph.json committed to repo as team-shared onboarding artefact — same position as Graphify; domain-view mapping (code → business concepts) addresses semantic gap in codebase memory
- [How LLMs work (minus the heavy math)](../../sources/2026-06-08-how-llms-work-osmani.md) — KV cache as external nervous system for agents: preserves history across autoregressive loops; RoPE + residual streams affect context retention in long sequences
