...
- [Fragments: June 2 (AI metrics, open vs closed models, hallucinated citations, LLM-assisted security)](../../sources/2026-06-09-fowler-fragments-ai-metrics.md) — Fowler: productivity metrics remain intractable (LOC, tickets closed, surveys all weak); Mozilla security case (17-31 bugs/month → 423/month) as rare constrained-domain proof point; open-model capability gap closing in 2-7 months
- [Emerging Patterns in Building GenAI Products](../../sources/2025-02-25-emerging-patterns-genai-products.md) — Fowler/Subramaniam (Thoughtworks, 2025): evals are mandatory in non-deterministic systems; LLM-as-judge + human eval combination; per-component evals for regression localisation; DeepEval code example
- [Lines of Code Got a Better Publicist](../../sources/2025-06-11-lines-of-code-better-publicist.md) — Curlewis/Vella: 'percent of code written by AI' is just lines of code with a better publicist — volume metrics replace outcome claims; PDSA cycles over top-down KPIs; practitioner signal is real data
