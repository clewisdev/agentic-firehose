...
- [last30days: Real-time research aggregator for pre-call context](../../sources/2025-06-12-last30days-client-prep.md) — Bridging knowledge-cutoff gap: ranked engagement signals from live sources injected as context; 'not more data, faster context, closer to reality'
- [Open Knowledge Format (OKF): vendor-neutral standard for LLM context](../../sources/2025-06-13-open-knowledge-format-okf.md) — OKF: format-first approach decouples knowledge structure from tooling; removes pipeline rebuild costs on model upgrades; verification gap unaddressed — how to validate correctness when agents update autonomously
- [Cowork: How to Set Up Claude for Non-Coders](../../sources/2026-06-09-cowork-claude-setup-guide.md) — Cowork context discipline: 22k-word raw transcript → 2k-token pattern extraction; anti-patterns (what to avoid) more actionable than aspirational guidance; folder structure as implicit schema
