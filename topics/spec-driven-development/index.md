...
- [5 takeaways from Kun (ex-Meta L8) on agentic engineering systems](../../sources/2026-06-09-kun-meta-agentic-workflow.md) — Spec quality as the primary autonomy lever: upfront investment in goals, specs, and validation criteria directly extends agent run time without human intervention
