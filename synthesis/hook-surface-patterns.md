...
Captain-hindsight from the Regnology snippet (sources/2026-05-28-regnology-teams-snippet.md) is semantically a SessionEnd pattern: post-session retrospective that generates recommendations for improving future sessions.
